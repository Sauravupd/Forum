...
urlpatterns = [
   ...
   url('reset/<uidb64>/<token>/',
    ...
    url(r'^boards/(?P<id>\d+)/topics/(?P<topic_pk>\d+)/$', views.topic_posts, name='topic_posts'),
    url(r'^boards/(?P<id>\d+)/topics/(?P<topic_pk>\d+)/reply/$', views.reply_topic, name='reply_topic'),
